...
const iconPaths = {
    ...
    clinic: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0v-4m0 4h5m0 0v-4m0 4h5m0 0v-4m-12-8h10" />,
...
const Hero = () => (
    <section id="home" className="relative text-white h-[60vh] md:h-[80vh] flex items-center bg-cover bg-center" style={{ backgroundImage: "url('https://placehold.co/1920x1080/2d3748/cccccc?text=Hospital+Waiting+Area')" }}>
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="container mx-auto px-8 md:px-16 relative z-10">
            <h2 className="text-4xl md:text-6xl font-bold leading-tight">Welcome to [Hospital Name]</h2>
            <p className="text-xl md:text-2xl mt-2">Your Health, Our Priority.</p>
            <p className="mt-4 max-w-lg">Brief about the hospital and its commitment to patient care and excellence in medical services.</p>
        </div>
    </section>
);
    ...
    <section className="bg-gray-900 text-white py-20 px-8 md:px-16">
        <div className="container mx-auto grid md:grid-cols-3 gap-12 text-center">
            <div className="feature-item">
                ...
                <p className="text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis.</p>
            </div>
            <div className="feature-item">
                <div className="flex justify-center mb-4">
                    <div className="p-4 bg-gray-800 rounded-full">
                ...
                <p className="text-gray-400">Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh.</p>
            </div>
            <div className="feature-item">
                <div className="flex justify-center mb-4">
                    <div className="p-4 bg-gray-800 rounded-full">
                ...
                <p className="text-gray-400">Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc.</p>
            </div>
        </div>
    </section>
);
    ...
    <section id="about" className="bg-gray-900 text-white py-20 px-8 md:px-16">
        <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 text-gray-400">
                <p>We have built a smarter way to manage hospital operations and patient care. Our platform makes it easy for patients to book online or offline appointments without login, receive instant confirmations, and get timely reminders via WhatsApp and email.</p>
                <p>Doctors and staff get powerful dashboards to manage schedules, view patient details, record medical history, issue prescriptions, and even track inventory — all in one place.</p>
                <p>By reducing paperwork and streamlining communication, we help hospitals run efficiently and give patients a faster, smoother healthcare experience.</p>
            </div>
        </div>
    </section>
);
