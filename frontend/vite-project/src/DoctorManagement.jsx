    ...
    const handleAddDoctor = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setError('Failed to add doctor: ' + errorData);
            }
        } catch (err) {
        ...
        <div className="min-h-screen bg-gray-900 py-8">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="bg-gray-800 rounded-lg p-6">
                    <h2 className="text-2xl font-bold text-white mb-6">Current Doctors</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {doctors.map((doctor) => (
                            <div key={doctor.doctor_id} className="bg-gray-700 rounded-lg p-6">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className={`px-2 py-1 rounded text-xs font-semibold ${
                                        doctor.active ? 'bg-green-800 text-green-200' : 'bg-red-800 text-red-200'
                                    }`}>
